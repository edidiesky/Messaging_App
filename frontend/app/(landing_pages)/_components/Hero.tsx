...
const Hero = () => {
    ...
    return <div className='min-h-[550px] bg-[#08090a] py-12 lg:py-24 flex items-center gap-8 justify-center'>
            ...
            <div className="w-full flex flex-col gap-8">
                ...
                <div className="flex items-center">
                    <div className="flex items-center justify-end gap-2 md:gap-4">
                        <span className=''>
                            <button onClick={() => dispatch(onLoginModal(""))}
                                className="text-xs lg:text-base px-4 lg:px-6 py-3 border-[#e7e7e736] border rounded-full text-dark bg-[#fff]">Start A Conversation</button>
                        </span>
                        <button onClick={() => dispatch(onRegisterModal(""))} className="text-xs lg:text-base text-white px-4 lg:px-6 py-3 rounded-full border-[#e7e7e736] border">Get Started</button>
                    </div>
                </div>
            </div>

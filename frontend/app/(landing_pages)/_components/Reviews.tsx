    ...
    return (
        ...
        <div className='flex w-full py-20 items-center bg-[#fff] gap-8 justify-center'>
            <div className="max-w-custom mx-auto w-[90%] flex flex-col gap-12 lg:gap-24">
                {/* <h2 className="text-3xl lg:text-5xl w-full lg:mx-auto max-w-[650px] leading-[1.3] md:text-center capitalize text-dark family2">
                ...
                <div className="w-full grid md:grid-cols-3 gap-8">
                    <div className="w-full flex flex-col gap-6">
                        ...
                        <div className="p-6 border rounded-xl flex flex-col gap-4">
                            ...
                            <div className="flex items-center gap-2">
                                <span className="text-3xl"><FaStar color='#ffbf0f' /></span>
                                <span className="text-3xl"><FaStar color='#ffbf0f' /></span>
                                <span className="text-3xl"><FaStar color='#ffbf0f' /></span>
                                <span className="text-3xl"><FaStar color='#ffbf0f' /></span>
                            </div>
                            <h4 style={{
                                lineHeight:"1.5"
                            }} className="text-xl md:text-2xl w-full pr-4">
                        ...
                        <div className="p-6 border rounded-xl flex flex-col gap-4">
                            <div className="w-full flex items-center gap-4">
                                ...
                                />
                                <h4 className="text-base md:text-lg family2 flex-1">
                                    Carlos Costa
                                    <span className="block text-sm lg:text-base text-[#777]">Foca</span>
                                </h4>

                            </div>
                            <h4 className="text-base md:text-base w-full pr-4">
                    ...
                    <div className="w-full flex flex-col gap-6">
                        <div className="p-6 border rounded-xl flex flex-col gap-4">
                            ...
                            <h4 className="text-base md:text-base w-full">

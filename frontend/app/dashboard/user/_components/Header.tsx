...
const Header = ({ title }: { title: string }) => {
    ...
    return (
        <div className='h-[63px] sticky top-0 items-center border-[#F3F3EE] justify-between flex border-b w-full px-4'>
            ...
            flex items-center hover:bg-[#eee] bg-[#F3F3EE] rounded-lg justify-center text-lg">
                <MdEdit />
            </div>
        </div>
    )

...
import { offCreateChannelModal, onGroupMemberModal } from '@/redux/slices/modalSlice';
import { slide } from '@/constants/framer';

const CreateChannelModal = () => {
    const { channelmodal } = useSelector((store: { modal: { channelmodal: boolean } }) => store.modal);
    ...
    return (
        <div
            ...
            <motion.div
                ...
                <form onSubmit={handleFormSubmision} className="w-full flex flex-col gap-6">
                    <div className="w-full px-6 flex items-center gap-4">
                        ...
                        <input
                            ...
                            className="text-base font-normal input bg-white rounded-full flex-1 "

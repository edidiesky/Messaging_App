...
import { offDeleteChannelModal } from '@/redux/slices/modalSlice';
...
const DeleteWorkspaceModal = () => {
    ...
    const { deletechannelmodal } = useSelector((store: { modal: { deletechannelmodal: boolean } }) => store.modal);
            ...
            <motion.div
                ...
                <div className="w-full flex px-8 items-center justify-between gap-1">
                    <h3 className="text-2xl md:text-2xl ">
                        ...
                        <span className="text-sm block text-[#777] max-w-[550px] md:text-sm">
                            Are you sure you want to delete this channel? This cannot be undone!
                        </span>
                    </h3>
                    {/* <div onClick={() => dispatch(offDeleteChannelModal(""))} className="text-[#000] cursor-pointer w-12 h-12 flex items-center hover:bg-[#fafafa] rounded-full justify-center text-xl">
                        <RxCross2 />
                    </div> */}
                </div>
                    ...
                    <div className="w-full text-sm flex px-8 py-4 border-t items-center justify-end gap-3">
                       ...
                       >
                        ...
                        <button
                            ...
                            onClick={handleoffDeleteMessageModal}
                            className="p-3 px-6 text-[#fff] flex items-center justify-center cursor-pointer  bg-[#f73760] rounded-full regular"
                        >
                            Delete
                        </button>
                    </div>
